...
import net.empire.ewmedieval.EwMedievalClient;
import net.empire.ewmedieval.client.model.equipment.CustomChestplateModel;
import net.empire.ewmedieval.client.model.equipment.chest.ChestplateAddonModel;
//import net.empire.ewmedieval.client.model.equipment.chest.capes.CloakCapeModel;
//import net.empire.ewmedieval.item.ModDataComponentTypes;
//import net.empire.ewmedieval.item.dataComponents.CapeDataComponent;
//import net.empire.ewmedieval.item.items.armor.CustomChestplateItem;
import net.empire.ewmedieval.item.utils.armor.ModArmorModels;
...
public class ChestplateArmorRenderer implements ArmorRenderer {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, BipedEntityModel<LivingEntity> contextModel) {
        this.customChestplateModel = new CustomChestplateModel<>(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(EwMedievalClient.CUSTOM_ARMOR_CHESTPLATE));
        this.capeModel = new CloakCapeModel<>(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(EwMedievalClient.CAPE_MODEL_LAYER));
        ...
        if (slot == EquipmentSlot.CHEST) {
            ...
            ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, customChestplateModel, Identifier.of(EwMedieval.MOD_ID, texture), dyeable);
            ...
            if (this.chestplateModel != null) {
                ...
                ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, this.chestplateModel, Identifier.of(EwMedieval.MOD_ID, texture.replaceAll("_chestplate.png", "_addition.png")), dyeable);
            }
            ...
            if (capeDataComponent != null) {
                ...
                if (ModDyeablePieces.dyeableCapes.containsKey(capeDataComponent.getCape())) {
                    CapeRenderer.renderDyeableCape(matrices, vertexConsumers, light, stack, capeModel, Identifier.of(EwMedieval.MOD_ID, "textures/models/cape/" + capeDataComponent.cape().getName() + ".png"), true);
                    if (ModDyeablePieces.dyeableCapes.get(capeDataComponent.cape()).booleanValue()){
                        ArmorRenderer.renderPart(matrices, vertexConsumers, light, stack, capeModel, Identifier.of(EwMedieval.MOD_ID, "textures/models/cape/" + capeDataComponent.cape().getName() + "_overlay.png"));
                    }
                } else {
                    ArmorRenderer.renderPart(matrices, vertexConsumers, light, stack, capeModel, Identifier.of(EwMedieval.MOD_ID, "textures/models/cape/" + capeDataComponent.cape().getName() + ".png"));
                }}
        }
    }
}