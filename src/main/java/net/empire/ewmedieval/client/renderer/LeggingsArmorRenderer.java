...
public class LeggingsArmorRenderer implements ArmorRenderer {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, BipedEntityModel<LivingEntity> contextModel) {
        this.customLeggingsModel = new CustomLeggingsModel<>(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(EwMedievalClient.CUSTOM_ARMOR_LEGGINGS));
        ...
        if (slot == EquipmentSlot.LEGS) {
            ...
            ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, customLeggingsModel, Identifier.of(EwMedieval.MOD_ID, texture), dyeable);
        }
    }
}