...
public class BootsArmorRenderer implements ArmorRenderer {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, BipedEntityModel<LivingEntity> contextModel) {
        this.customBootsModel = new CustomBootsModel<>(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(EwMedievalClient.CUSTOM_ARMOR_BOOTS));
        ...
        if (slot == EquipmentSlot.FEET) {
            ...
            ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, customBootsModel, Identifier.of(EwMedieval.MOD_ID, texture), dyeable);
        }
    }
}