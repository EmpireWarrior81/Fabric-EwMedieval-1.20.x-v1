...
public class HoneyGlazedHamBlock extends FeastBlock {
    ...
    protected static final VoxelShape ROAST_SHAPE = VoxelShapes.union(
            PLATE_SHAPE,
            Block.createCuboidShape(4.0D, 2.0D, 4.0D, 12.0D, 10.0D, 12.0D));

    public HoneyGlazedHamBlock(Settings settings, Supplier<Item> servingItem, boolean hasLeftovers) {
